...
class CustomeSnackbar {
  ...
  static void show(String message) {
    _showSnackBar(message, backgroundColor: AppColors.pText);
  }
  ...
  static void loading(String message) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: AppColors.pText,
        behavior: SnackBarBehavior.floating,
        margin: const EdgeInsets.all(16),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
      ...
      AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: Text(
              cancelText,
              style: const TextStyle(color: AppColors.pText),
            ),
          ),
          TextButton(
            ...
            child: Text(
              confirmText,
              style: TextStyle(
                color: isDanger ? AppColors.error : AppColors.pText,
            ...
            child: Column(
              ...
              children: [
                ...
                if (message != null) ...[
                  ...
                  Text(
                    message,
                    style: TextStyle(color: AppColors.titleText, fontSize: 14),
                  ),
                ],
              ],
            ),
